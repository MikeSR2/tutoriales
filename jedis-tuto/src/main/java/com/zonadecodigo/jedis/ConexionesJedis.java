...
public final class ConexionesJedis {
    ...
    private void poolDeConexiones() {
        ...
        //Creacion del pool de conexiones, este objeto podria reutilizarse en la aplicacion para obtener conexiones
    ...
    private void conexionCluster() {
        ...
        Set<HostAndPort> nodosCluster = new HashSet<>();
